        ...
        <div class="col-lg-6">
            ...
            <table class="table table-condensed table-hover">
                ...
                <tr>
                    ...
                    <td><b class="text-info"> <?= $payedWhole ?> &#8381;</b> из <b
                                class="text-warning"> <?= $plannedTotal ?> &#8381;</b> <b
                                class="text-info">(<?= $payedPercent ?>%)</b></td>
                </tr>
                <tr>
                    <td>Оплачено счетов (по данным программы)</td>
                    <td><b class="text-info"> <?= $values['pay'] ?></b> из <b
                                class="text-warning"> <?= $values['cottages_count'] ?></b></td>
                </tr>
                <tr>
                    <td>Оплачено счетов (вне программы)</td>
                    <td><b class="text-info"> <?= $values['pay_outside'] ?></b> из <b
                                class="text-warning"> <?= $values['cottages_count'] ?></b></td>
                </tr>
                <tr>
                    <td>Оплачено счетов всего (теоретически)</td>
                    <td><b class="text-info"> <?= $values['pay_untrusted'] ?></b> из <b
                                class="text-warning"> <?= $values['cottages_count'] ?></b></td>
                </tr>
                <?php
                if ($values['additional_cottages_count'] > 0) {
                    ...
                    <tr>
                        ...
                        <td><b class="text-info"> <?= $values['pay_additional'] ?></b> из <b
