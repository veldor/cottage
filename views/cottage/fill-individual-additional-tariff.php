...
<div class="row">
	<?php
	/** @var array $info */
	$form = ActiveForm::begin(['id' => 'personalTariff', 'options'=> ['class' => 'form-horizontal bg-default'],'enableAjaxValidation' => false,'action'=>['/fill/membership-personal-additional/' . $info['cottageNumber'] . '/' . TimeHandler::getCurrentQuarter()]]);
