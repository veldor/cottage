...
/* @var $model IndividualTarget */

$form = ActiveForm::begin(['id' => 'individualTargetTariff', 'options' => ['class' => 'form-horizontal bg-default'], 'enableAjaxValidation' => false, 'validateOnSubmit' => false, 'action' => [Url::toRoute(['forms/target-individual', 'accrualId' => $data->id])]]);
