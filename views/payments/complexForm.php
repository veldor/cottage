...
//            echo "<div class='col-xs-12 power-container hoverable additional' data-summ='{$cost}'><table class='table table-condensed'><tbody><tr><td><input type='checkbox' name=>{$date}</td><td class='text-right'><b class='text-danger popovered' data-toggle='popover' title='Детали платежа' data-placement='left' data-content=\"{$description}\">" . CashHandler::toSmoothRubles($cost) . "</b> <button type='button' class='btn btn-info no-limit popovered glyphicon glyphicon-star additional' data-toggle='popover' title='Редактирование' data-placement='right' data-content='Без льготного лимита' data-difference='{$value['difference']}' data-overcost='{$value['powerOvercost']}' data-month='{$value['month']}'></button></td></tr></tbody></table></div>";
//        } else {
...
//
//        echo "<div class='col-lg-12 text-center membership-container hoverable main' data-summ='{$value['total_summ']}'><table class='table table-condensed'><tbody><tr><td><input type='checkbox' class='form-control' name='ComplexPayment[membership][$key]'/>{$date}</td><td><b class='text-danger popovered' data-toggle='popover' title='Детали платежа' data-placement='left' data-content=\"$description\">" . CashHandler::toSmoothRubles($value['total_summ']) . "</b></td></tr></tbody></table></div>";
